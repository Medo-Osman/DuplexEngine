...
class MoveInGridAction : public BossStructures::BaseAction
{
private:
...
public:
	MoveInGridAction(Entity* bossEntity, BossSubject* bossSubject, BossStructures::PlatformArray* platformArray, Vector2 moveHowMany, float speed, Vector2* currentPlatformIndex)
