...
enum class ComponentType { MESH, ANIM_MESH, AUDIO, PHYSICS, CHARACTERCONTROLLER, TRIGGER, TEST, INVALID, UNASSIGNED, ROTATEAROUND, ROTATE, LIGHT, SWEEPING, FLIPPING, CHECKPOINT, TRAP, PARTICLE, PROJECTILE, GROW, SHRINK, SWING, SWEEPING2};
