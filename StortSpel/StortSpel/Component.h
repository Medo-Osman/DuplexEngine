...
enum class ComponentType { MESH, AUDIO, PHYSICS, CHARACTERCONTROLLER, TRIGGER, TEST, INVALID, UNASSIGNED, ROTATEAROUND, ROTATE, LIGHT, SWEEPING, FLIPPING, CHECKPOINT};
